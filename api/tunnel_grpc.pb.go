...
type TunnelServiceClient interface {
	EstablishTunnel(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ClientToServer, ServerToClient], error)
}
...
func (c *tunnelServiceClient) EstablishTunnel(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ClientToServer, ServerToClient], error) {
...
type TunnelService_EstablishTunnelClient = grpc.BidiStreamingClient[ClientToServer, ServerToClient]

// TunnelServiceServer is the server API for TunnelService service.
// All implementations must embed UnimplementedTunnelServiceServer
// for forward compatibility.
type TunnelServiceServer interface {
	EstablishTunnel(grpc.BidiStreamingServer[ClientToServer, ServerToClient]) error
...
func (UnimplementedTunnelServiceServer) EstablishTunnel(grpc.BidiStreamingServer[ClientToServer, ServerToClient]) error {
...
func _TunnelService_EstablishTunnel_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TunnelServiceServer).EstablishTunnel(&grpc.GenericServerStream[ClientToServer, ServerToClient]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TunnelService_EstablishTunnelServer = grpc.BidiStreamingServer[ClientToServer, ServerToClient]
